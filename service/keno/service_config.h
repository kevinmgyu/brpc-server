...
DECLARE_string(keno_path);
DECLARE_string(full_node_path);
DECLARE_string(full_node_url);
DECLARE_string(sign_ip);
DECLARE_string(sign_port);
DECLARE_int32(sign_fd_cnt);
DECLARE_int32(sign_timeout);
DECLARE_string(rooms_info);
...
DECLARE_string(transfer_seed_from);
DECLARE_string(transfer_seed_to);
DECLARE_uint64(seed_change_num);
