...
class metrics : public ::google::protobuf::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline metrics() {};
 public:
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(metrics);
};

class metrics_Stub : public metrics {
 public:
  metrics_Stub(::google::protobuf::RpcChannel* channel);
  metrics_Stub(::google::protobuf::RpcChannel* channel,
                   ::google::protobuf::Service::ChannelOwnership ownership);
  ~metrics_Stub();
 ...
 private:
  ::google::protobuf::RpcChannel* channel_;
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(metrics_Stub);
};
